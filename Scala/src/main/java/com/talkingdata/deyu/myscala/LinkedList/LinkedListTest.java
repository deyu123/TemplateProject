package com.talkingdata.deyu.myscala.LinkedList;
...
public class LinkedListTest {
     ...
     */
    public Node findFirstCrossPoint(LinkedListTest linkedList1, LinkedListTest linkedList2) {
        //链表不相交
...
//    public boolean
    ...
    public static void main(String[] args) {
        ...
        linkedListTest.addNode(10);
        linkedListTest.addNode(11);
        linkedListTest.addNode(12);
        linkedListTest.addNode(13);
        linkedListTest.addNode(14);
        linkedListTest.printLink();
        linkedListTest.swapPairs();
        linkedListTest.printLink();
